...
func (r *TrainedModelReconciler) updateStatus(req ctrl.Request, desiredModel *v1alpha1api.TrainedModel) error {
	...
	if isvc.Status.URL != nil {
		// Update status to contain the isvc URL with /v1/models/trained-model-name:predict append
	...
	if isvc.Status.Address != nil {
		if isvc.Status.Address.URL != nil {
			////Update status to contain the isvc address with /v1/models/trained-model-name:predict append
